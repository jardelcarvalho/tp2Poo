...
class Principal extends javax.swing.JFrame {
    private ClienteView clienteView = null;
    private ServicoView servicoView = null;
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        clienteView = clienteView == null ? (ClienteView) FactoryProducer.getFactory("view").getView("cliente") : clienteView;
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        if(servicoView != null){
            if(!servicoView.isVisible()){
                servicoView.setVisible(true);
            }
        }
        servicoView = clienteView == null ? (ServicoView) FactoryProducer.getFactory("view").getView("servico") : servicoView;
